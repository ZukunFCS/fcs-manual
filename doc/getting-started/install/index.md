...
```{figure} images/install_01.jpg
:width: 80%
:align: center
```

2. インストールを開始します。  
```{figure} images/install_02.jpg
:width: 80%
:align: center
```
  
3. 使用許諾契約書に同意します。   
```{figure} images/install_03.jpg
:width: 80%
:align: center
```
...
```{figure} images/install_05.jpg
:width: 80%
:align: center
```
  
6. デスクトップアイコンを作成する場合は、チェックを入れてください。  
```{figure} images/install_06.jpg
:width: 80%
:align: center
```
  
7. インストールを設定の確認し、問題がなければインストールしてください。  
```{figure} images/install_07.jpg
:width: 80%
:align: center
```
   
8. 完了後、すぐ起動する場合は、チェックを入れてください。  
```{figure} images/install_08.jpg
:width: 80%
:align: center
```
...
```{figure} images/uninstall_01.jpg
:width: 80%
:align: center
```

2. 問題がなければOKを選択します。  
```{figure} images/uninstall_02.jpg
:width: 80%
:align: center
```
