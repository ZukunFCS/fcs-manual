...
3,Videosウィンドウにimportした動画が表示されます。  
...
【+】を押すと、Galleryに指定したフレームの画像が追加されます。  
...
2.追加した赤色の画像をクリックし、Editor画面の画像と同じであることを確認してください。
...
1.VideoTimelineウィンドウのスライダーを動かし、表情の登録を行いたいフレームで止め、  
【+】を押すと、Galleryに指定したフレームの画像が追加されます。  
追加した赤色の画像をクリックし、Editor画面の画像と同じであることを確認してください。  
```{list-table}
:widths: 50 50
:header-rows: 0
