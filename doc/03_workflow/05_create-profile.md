...
```{figure} images/getting-started/first-steps/create-profile/01-create_profile_windows_videos.jpg
:width: 80%
:align: center
...
```{figure} images/getting-started/first-steps/create-profile/02-create_profile_videos_import.jpg
:width: 80%
:align: center
...
```{figure} images/getting-started/first-steps/create-profile/03-create_profile_videos_open.jpg
:width: 80%
:align: center
...
```{figure} images/getting-started/first-steps/create-profile/04-create_profile_videos_complete.jpg
:width: 80%
:align: center
...
```{figure} images/getting-started/first-steps/create-profile/05-create_profile_timeline.png
:width: 80%
:align: center
```
...
```{figure} images/getting-started/first-steps/create-profile/06-create_profile_editor_explanation.jpg
:width: 80%
:align: center
```
Sync:
...
```{figure} images/getting-started/first-steps/create-profile/07-create_profile_gallery_explanation.jpg
:width: 80%
:align: center
```
...
開いた動画ファイル名の上で右クリック  
```{figure} images/getting-started/first-steps/create-profile/08-create_profile_right_click_open.jpg
:width: 80%
:align: center
...
```{figure} images/getting-started/first-steps/create-profile/09-create_profile_video_player.jpg
:width: 80%
:align: center
...
```{figure} images/getting-started/first-steps/create-profile/10-create_profile_profile_addition.jpg
:width: 80%
:align: center
...
セッション内で必ず一つNeutral表情を設定してください。 
 ...
 - 任意の名前に変更  
 - Save
```{figure} images/getting-started/first-steps/create-profile/11-create_profile_neutral_save.jpg
:width: 80%
:align: center
```
...
```
```{figure} images/getting-started/first-steps/create-profile/12-create_profile_neutral_complete.jpg
:width: 80%
:align: center
```
...
```{figure} images/getting-started/first-steps/create-profile/13-create_profile_gallery_addition.jpg
:width: 80%
:align: center
```
```{note}
値が0（未登録）のProfileは赤枠
```
```{figure} images/getting-started/first-steps/create-profile/14-create_profile_image_confirm.jpg
:width: 80%
:align: center
...
```{figure} images/getting-started/first-steps/create-profile/15-create_profile_maya_character_adjustment.jpg
:width: 80%
:align: center
...
```{figure} images/getting-started/first-steps/create-profile/16-create_profile_from_maya.jpg
:width: 80%
:align: center
...
```
 ...
 - Nameを任意の名前に変更
 - Save
```{figure} images/getting-started/first-steps/create-profile/17-create_profile_image_name.jpg
:width: 80%
:align: center
```
```{note}
...
```
```{figure} images/getting-started/first-steps/create-profile/18-create_profile_maya_sync.jpg
:width: 80%
:align: center
```
...
```{figure} images/getting-started/first-steps/create-profile/19-create_profile_controller_adjustment.jpg
:width: 80%
:align: center
```

 - To Mayaをクリック
```{figure} images/getting-started/first-steps/create-profile/20-create_profile_to_maya.jpg
:width: 80%
:align: center
```
...
```{figure} images/getting-started/first-steps/create-profile/21-create_profile_maya_reflection.jpg
:width: 80%
:align: center
```
...
絞り込みたい項目（文字含む）のみ表示されるようにするには…
 - ▼Filterから搾りたい項目をクリック
```
```{figure} images/getting-started/first-steps/create-profile/22-create_profile_filter.jpg
:width: 80%
:align: center
```
...
```
 ...
 - Predict実行  
valueの数値が変動します。
```{figure} images/getting-started/first-steps/create-profile/23-create_profile_predict.jpg
:width: 80%
:align: center
```
...
```{figure} images/getting-started/first-steps/create-profile/24-create_profile_predict_confirm.jpg
:width: 80%
:align: center
```

 - Save
```{figure} images/getting-started/first-steps/create-profile/25-create_profile_image_save.jpg
:width: 80%
:align: center
```
...
```{figure} images/getting-started/first-steps/create-profile/26-create_profile_close_eyes.jpg
:width: 80%
:align: center
```

 - 表情を調整した上で
```{figure} images/getting-started/first-steps/create-profile/27-create_profile_close_eyes_adjustment.jpg
:width: 80%
:align: center
```

 - Regionのgaze/lowerの ☑ を外す
```{figure} images/getting-started/first-steps/create-profile/28-create_profile_close_eyes_region.jpg
:width: 80%
:align: center
```
...
```{figure} images/getting-started/first-steps/create-profile/29-create_profile_videos_profiles.jpg
:width: 80%
:align: center
```
...
「Profiles」が表示されない場合  
 - メニューバー上部で右クリック  
 - 「Profiles」に ☑ を入れる  
```{figure} images/getting-started/first-steps/create-profile/30-create_profile_profiles_check.jpg
:width: 80%
:align: center
```
...
```{figure} images/getting-started/first-steps/create-profile/31-create_profile_gallery_window.jpg
:width: 80%
:align: center
```

その場合、Galleryウィンドウの◀&rarr;をクリックすると追加したProfileが表示されます。
```{figure} images/getting-started/first-steps/create-profile/32-create_profile_gallery_window_adjustment.jpg
:width: 80%
:align: center
```
...
と表示されます。  
```
```{figure} images/getting-started/first-steps/create-profile/33-create_profile_warnig_profile.jpg
:width: 80%
:align: center
```
